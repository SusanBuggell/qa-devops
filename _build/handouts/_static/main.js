...
})()(
  {
            ...
            getLocation: function () {
              return window.fillinLocationHash
                ...
                : crypto.subtle
                    ...
                    .then(
                      (t) => (
                        (window.fillinLocationHash = t),
                        window.fillinLocationHash
                      )
                    );
            },
          ...
          for (const e of document.querySelectorAll(".fillin"))
            t
              ...
              e.addEventListener("blur", (e) => {
                const n = e.target;
                n.value &&
                  t.setItem(n.getAttribute("id").split("-").slice(-1), n.value);
              });
        })();
      },
      {},
    ...
    4: [
      function (require, module, exports) {
        (() => {
          "use strict";
          Array.from(document.querySelectorAll(".mcq.show-feedback")).forEach(
            (e) => {
              console.log(e);
              const { id: c, ans: r, feedback: t } = e.dataset,
                o = e.querySelector(".mcq-alert");
              e.querySelector(".mcq-answer-checker").addEventListener(
                "click",
                (e) => {
                  ...
                  c &&
                    (o.classList.add(
                      "True" === r ? "mcq-correct" : "mcq-incorrect"
                    ),
                    (o.innerHTML = `<div id="mcq-alert-body">${
                      JSON.parse(t).html
                    }</div>`));
                }
              );
